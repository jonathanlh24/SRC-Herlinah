...
<form action="/profilePemilik" method="post">
    @csrf
...
<div class="modal fade" id="ModalGantiPassword" tabindex="-1" role="dialog" aria-labelledby="GantiPasswordModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="/gantiPasswordPemilik" method="post">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input name="passlama" type="password" value="" class="input form-control" id="passlama" placeholder="Masukkan Password Lama" required="true" aria-label="password" aria-describedby="basic-addon1" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input name="passbaru" type="password" value="" class="input form-control" id="passbaru" placeholder="Masukkan Password Baru" required="true" aria-label="password" aria-describedby="basic-addon1" />
                                <div class="input-group-append">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input name="konfirmasipassbaru" type="password" value="" class="input form-control" id="konfirmasipassbaru" placeholder="Konfirmasi Password Baru" required="true" aria-label="password" aria-describedby="basic-addon1" />
                                <div class="input-group-append">
